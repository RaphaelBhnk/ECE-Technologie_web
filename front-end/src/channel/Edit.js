...
<a class="effectless" href="#popupDelete"> <DeleteIcon
                          color="secondary"
                          >
                          Supprimer
                        </DeleteIcon></a> 
    ...
    <div class="popup">
      ...
      <TextField id="filled-basic edit" label="Content " variant="filled" required/>
      <div className={classes.root}>
      <Button onClick={editMessage} href="#">ADD</Button>
       </div>
       </form>
      </div>
    </div>
  ...
  <div id="popupDelete" class="overlay">
    <div class="popup">
      ...
      <form className={classes.root} noValidate autoComplete="off">
      <div className={classes.root}>
      <Button onClick={deleteMessage} href="#">CONFIRM</Button>
       </div>
       </form>
      </div>
    </div>
