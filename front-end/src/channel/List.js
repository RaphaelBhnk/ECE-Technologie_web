  ...
  return (
    <div css={styles.root} ref={rootEl}>
      <div>
        ...
        {channel.owner === oauth.email ? (
          <span css={styles.corner}>
            <Button
            ...
            <Menu
              ...
              onClose={handleClose}
            >
              <a class="effectless" href="#popupRename">
                <MenuItem>Rename channel</MenuItem>
              </a>
              <a class="effectless" href="#popupAdd">
                <MenuItem>Add member</MenuItem>
              </a>
              <a class="effectless" href="#popupDel">
                <MenuItem>Delete this channel</MenuItem>
              </a>
              <a class="effectless" href="#popupAdmin">
                <MenuItem>Make someone administrator</MenuItem>
              </a>
            </Menu>
          </span>
        ...
        //   Rename channel
        // </Button>
        channel.administrators.indexOf(oauth.email) !== -1 ? (
          <span css={styles.corner}>
            <Button
              aria-controls="simple-menu"
              aria-haspopup="true"
            ...
            <li key={i} css={styles.message}>
              ...
              {message.author === oauth.email ? (
                <div>
                  <div>
                    <Edit
                      messageCreation={message.creation}
                      channel={channel}
                    />
                    <br></br>
                  </div>
                  <div
                    css={styles.myMessage}
      ...
      <div id="popupDel" class="overlay">
        <div class="popup">
          ...
          <div class="content">
            <form className={classes.root} noValidate autoComplete="off">
              <div className={classes.root}>
                <Button onClick={deleteChannel} href="#">
                  DELETE
                </Button>
              </div>
            </form>
