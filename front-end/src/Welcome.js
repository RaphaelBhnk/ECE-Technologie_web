...
const useStyles = (theme) => ({
  root: {
    backgroundColor: 'rgba(54, 45, 71, 0.99)',
            ...
            <div css={styles.tampon}>
              <div css={styles.firstPartForm}>
                <div css={styles.element}>
                  <TextField  name="Username" id="outlined-textarea username" label="Username" placeholder="" multiline variant="outlined" required/>
                </div>
                <div css={styles.element}>
